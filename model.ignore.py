...
#                                      os.path.join(cache_dir, 'envibert_tokenizer.py')).load_module().RobertaTokenizer(
#     cache_dir)
#
#
...
#                 punctuation_loss = self.punctuation_loss_fct(punctuation_classifier_logits.view(-1, 4),
#                                                              punctuation_labels.view(-1))
#
...
#     path = '/home/huydang/project/nemo_capu/checkpoints/training_500k_no_weight/2022_06_08_02_15_26/checkpoint_29.ckpt'
#
...
#     model = HuyDangCapuModel(None, bert, punctuation_class_weight=None, capital_class_weight=None)
#     model.load_state_dict(torch.load(path))
#
#     sentence_ls = [
#         'nếu điều trị ngoại trú sẽ không được hưởng bảo hiểm y tế nếu con chị đi khám tại bệnh viện tuyến huyện ở hà nội sẽ được hưởng 80% chi phí khám bệnh chữa bệnh',
#         'bạn tên là gì']
#
